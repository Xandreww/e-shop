...
class Component extends React.Component {
  ...
  render() {
    ...
    return (
      <CardDeck className={styles.root}>
        <Card>
          <Card.Img variant="top" src={xbox} className={styles.image} />
          <Card.Body>
        ...
        <Card>
          <Card.Img variant="top" src={ps} className={styles.image} />
          <Card.Body>
            <Card.Title>Card title</Card.Title>
        ...
        <Card>
          <Card.Img variant="top" src={macbook} className={styles.image} />
          <Card.Body>
            <Card.Title>Card title</Card.Title>
            <Card.Text>
